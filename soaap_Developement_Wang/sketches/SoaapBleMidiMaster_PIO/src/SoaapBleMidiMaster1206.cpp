...
#ifdef MidiControlChange
  #define MidiControlCycleTimer 450

  // ----------------------------------------------------------------------------
  MidiControl   midiControlChange;
  // ----------------------------------------------------------------------------
  //
  //
...
// ============================================================================
{
  ...
  #ifdef MidiControlChange
  // --------------------------------------------------------------------------
  // Konfiguration des Klasse MidiControl Change
  // --------------------------------------------------------------------------
  //
...
// ============================================================================
{
  ...
  // MidiControll
#ifdef MidiControlChange
  if(lc.timerMicro(lcTimer4, MidiControlCycleTimer, 0, 1000) )
  {
    midiControlChange.run();
  }
#endif
...
// Midi Contorl Change mappig TEST
#ifdef MidiControlChange

void getCcResultRoll()
{
